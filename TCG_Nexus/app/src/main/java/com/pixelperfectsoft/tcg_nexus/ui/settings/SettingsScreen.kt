...
@Composable
fun SettingsScreen(navController: NavHostController, darktheme: MutableState<Boolean>) {
...
/*
    ...
    Column(
        ...
        if (themedialog.value) {
            ThemeDialog(themedialog, darktheme)
        }
...
@Composable
fun ThemeDialog(themedialog: MutableState<Boolean>, darktheme: MutableState<Boolean>) {
    val colors = listOf(
        Color(92, 115, 255),
        Color(255, 92, 92),
        Color(92, 255, 92),
